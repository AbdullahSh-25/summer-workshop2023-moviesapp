  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        return switch (state.movieDetailsState) {
          RequestState.initial => const SizedBox.shrink(),
          RequestState.loading => const LoadingWidget(),
          RequestState.error => ErrorMessageWidget(message: state.movieDetailsMessage),
      ...
      builder: (context, state) => SliverGrid(
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            ...
            final RecommendationModel recommendation = state.recommendation[index];
